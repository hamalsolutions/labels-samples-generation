...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	texto($STYLE, 15, 48, 0, 0, $arial, $black, 10, 0, 0);

	if (strlen($DESCRIPTION) > 21) {
		texto($DESCRIPTION, 15, 68, 0, 0, $arial70, $black, 10, 0, 0);
	} else {
		texto($DESCRIPTION, 15, 68, 0, 0, $arial, $black, 10, 0, 0);
	}

	texto($COLOR, 15, 88, 0, 0, $arial, $black, 10, 0, 0);

	texto($SIZE, 15, 108, 0, 0, $arial, $black, 10, 0, 0);

	// Creacion del Barcode
	barcode($UPC, 20, 96, 1.3, 78, 'UPC');
