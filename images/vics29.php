<?php                     //   1       2       3      4      5
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        //texto('CELEBRITY PINK',0,19,1,0,$arialBold,$black,9,0,0);
        
        imagefilledellipse($img,75,30,15,15,$transparent);
        imageellipse($img,75,30,15,15,$gray);
        
        texto($STYLE,9,49,0,0,$arial,$black,strlen($STYLE)>10?6:7,0,0);
        
        texto($COLOR,0,49,2,5,$arial,$black,strlen($COLOR)>10?6:7,0,0);
