...
$correctos = array('QTY','STYLE','COLOR','DESCRIPTION','SIZE','UPC','SEASON','DEPT','SUB','FINELINE','PRICE','SUPPLIER','REPLENISHMENT','CPSIA');
...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	$SUPP = asignar(11, 'supplier');
    $REPLEN = asignar(12, 'replenish');
    $TRACKIN = asignar(13, 'CPSIA trackng');
    ...
    texto($REPLEN, 10, 158, 0, 0, $arial, $black, 6.5, 0, 0);
    texto($SUPP, 0, 158, 2, 8, $arial, $black, 6.5, 0, 0);
    ...
    texto($TRACKIN, 0, 230, 1, 0, $arialBold, $black, 6.5, 0, 0);
