<?php                      //   1      2       3      4        5          6   
    $correctos = array('QTY','COLOR','SIZE','STYLE','EAN13','DESCRIPTION','PRICE');
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        texto($PRICE,0,277,1,0,$arial,$black,12,0,0);
        
        
        // Creacion del Barcode
        barcode($EAN13,9,125,1.3,105,'EAN');
        
        barcodeTexto(2,-1,-2,5,'OCR-B_SB.ttf');
