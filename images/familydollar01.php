...
$correctos = array('QTY', 'CATEGORY', 'SIZE', 'PRICE', 'DESCRIPTION', 'COLOR', 'UPC', 'TRACKING');
...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	$TRACKING = asignar(7, 'MIDWOODBRANDSLLC1917640277440717');
	...
	texto($COLOR, 440, 45, 2, 10, $arialNBold, $black, 7, 0, 0);

	// Creacion del Barcode
	barcode($UPC, 50, 315, 1, 35, 'UPC', 90);
