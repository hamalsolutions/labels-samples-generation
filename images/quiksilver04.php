<?php                    //    1        2      3      4      5    
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        $COLOR = asignar(1,'GREEN GECKO');
        $SIZE = asignar(2,'XL');
        $STYLE = asignar(3,'40A64023-32');
        $UPC = asignar(4,'123456789128');
        $PRICE = asignar(5,'$19.00 CAD');
        $DESCRIPTION = asignar(6,'CHECK MY SPRAY');
        $COLORCODE = asignar(7,'GGYO');
        ...
        texto($DESCRIPTION,0,115,1,0,$arial,$black,7.5,0,0);
        ...
        $strPrice = str_replace("CAD","",str_replace("$", "", $PRICE));
        if(strlen($strPrice) > 3){
           texto($strPrice . " CAD",0,385,1,0,$arialBold,$black,11,0,1);
        }
