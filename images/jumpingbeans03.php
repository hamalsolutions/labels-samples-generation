...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	texto('SIZE  ' . $SIZE, 87, 11, 0, 0, $arialNBold, $black, 7, 0, 0);

	texto($COLOR, 119, 21, 0, 0, $arialNBold, $black, 6.5, 0, 0);

	texto($GROUPOUT, 64, 89, 3, 270, $arialBold, $black, 6.5, 0, 0);
	...
	texto($COLOR_CODE, 87, 21, 0, 0, $arialNBold, $black, 6.5, 0, 0);
