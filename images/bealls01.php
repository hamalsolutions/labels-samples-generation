<?php                    //    1        2     3     4       5       6       7
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        texto('DPT '.$DEPT,0,78,3,75,$arialBold,$black,9,0,0);
        
        texto('CL '.$CLASS,0,78,3,-80,$arialBold,$black,9,0,0);
        
        texto($STYLE,20,98,0,0,$tahomaBold,$black,11,0,0);
        
        texto('COLOR',20,120,0,0,$tahomaBold,$black,9.5,0,0);
        
        if (strlen($COLOR)<11)
            texto($COLOR,0,120,2,5,$tahomaBold,$black,9,0,0);
        else
            texto($COLOR,0,120,2,5,$tahomaBold,$black,7,0,0);
