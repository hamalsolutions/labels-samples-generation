<?php                     //      1         2     3     4       5
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        texto($STYLE,0,65,2,10,$arialBold,$black,9,0,0);
        texto($COLOR,0,80,2,10,$arialBold,$black,9,0,0);
        ...
        texto(sinSigno($PRICE),0,290,2,20,$arialBold,$black,13,0,0);
        
            // Creacion del Barcode
        barcode($UPC,8,78,1.3,95,'UPC');
