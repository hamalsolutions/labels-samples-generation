...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	$STYLE = asignar(1, '1KRRNVLU');
	$COLOR = asignar(2, 'BLK/BLACK');
	$SIZE = asignar(3, 'XS');
	$UPC = asignar(4, '637677409838');
	$PRICE = asignar(5, '$39.00');
	$GROUP_NAME = asignar(6, '');
	$DESCRIPTION = asignar(7, '3-FER');
	...
	texto($PRICE, 0, 316, 2, 25, $arialBold, $black, 14, 0, 1);
