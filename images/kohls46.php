<?php                      //   1      2       3      4     5      6      7       8
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        texto('KOHL\'S',0,45,1,0,$arialBold,$black,20,270,0);
        texto('Kohls.com',0,60,1,0,$arialBold,$black,10,270,0);
        
        texto($DEPT,0,80,3,80,$arialBold,$black,15,270,0);
        
        texto($CLASS,0,80,1,0,$arialBold,$black,15,270,0);
        
        texto($SUB,0,80,3,-80,$arialBold,$black,15,270,0);
