<?php //                     1       2      3      4     5         6          7
$correctos = array('QTY', 'STYLE','COLOR','SIZE','UPC','MSRP','GROUP NAME','NAME','EPC_HEX');
...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	$GROUPNAME = asignar(6, 'GROUP NAME OR DESCRIPTION');
	$NAME = asignar(7, 'BRAND NAME');
	$EPC_HEX =  asignar(7, ''); // This field is not going to be used to display data it will be filled at Prin-time
	...
	texto('*', 10, 15, 0, 0, $arial, $lgray, 8, 0, 0);
	...
	if (strlen($GROUPNAME) > 24) {
		texto($GROUPNAME, 0, 230, 1, 0, $arial70B, $black, 8.5, 0, 0);
	} else {
		texto($GROUPNAME, 0, 230, 1, 0, $arialNB, $black, 8.5, 0, 0);
	}
