...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	$yPos = 130;
	for ($i = 1; $i <= 2; $i++) {
		texto($SIZE, 0, $yPos + 2, 1, 0, $arialBold, $black, 12, 270, 0);
		If (strlen($SIZE2) <> 0) {
			texto($SIZE2, 0, $yPos + 12, 1, 0, $arialNBold, $black, 8, 270, 0);
			$yPos += 12;
		}
	...
	cajaRellena(1, 206, 90, 20, $orange, $orange, 270);
	...
	texto('Kohls.com', 30, 18, 0, 0, $arialBold, $black, 5, 0, 0);

	texto('k', 30, 11, 0, 0, $logo, $black, 10, 0);

	texto('SIZE  ' . $SIZE, 88, 11, 0, 0, $arialNBold, $black, 7, 0, 0);
	...
	// Need tp ad the DEPT with 3 digits
