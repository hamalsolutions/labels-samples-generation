...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	$DESCRIPTION = asignar(1, 'THE EASY STYLETTO WITH ROLLED HEM');
	$STYLE = asignar(2, '18-3-002629-PT00943');
	$COLOR = asignar(3, 'BLACJ POLKA DOT');
	$SIZE = asignar(4, '23');
	$UPC = asignar(5, '884926947393');
	...
	texto('CURRENT ELLIOT', 0, 55, 1, 0, $arial, $black, 10, 0, 0);
