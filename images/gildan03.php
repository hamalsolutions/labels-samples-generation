<?php                     //    1      2       3      4      5      6        7          8         9
    $correctos = array('QTY','COLOR','SIZE','STYLE','UPC','PRICE','FINELINE','SEASON','DEPT','SUB','DESCRIPTION');
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        $DEPT = asignar(8,'55');
        $SUB = asignar(9,'009');
        $DESCRIPTION = asignar(10,'YOUTH SHORT SLEEVE TEE');
        ...
        for($i=1;$i<=5;$i++){
            ...
            if ($i % 2 == 0) {
                ...
                texto($DESCRIPTION,0,$yPos+30,1,0,$arialNarrowBold,$black,7,0,0);
