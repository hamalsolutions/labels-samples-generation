<?php                       //   1       2       3     4     5       6     7    
    $correctos = array('QTY','STYLE','COLOR','SIZE','UPC','PRICE','DEPT','SEASON');
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        texto($STYLE,10,115,0,0,$arialBold,$black,8,0,0);
        
        texto($COLOR,10,126,0,0,$arialBold,$black,8,0,0);
        
        texto($SIZE,10,136,0,0,$arialBold,$black,8,0,0);
        ...
        texto($PRICE,0,143,2,7,$arialBold,$black,11,0,1);
