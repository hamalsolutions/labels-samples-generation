<?php //                     1       2        3        4        5      6       7        8
$correctos = array('QTY', 'DEPT', 'CLASS', 'STYLE', 'COLOR', 'SIZE', 'UPC', 'PRICE', 'GROUP NAME');
...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	$GROUPNAME = asignar(8, 'GROUP NAME');
	...
	if (strlen($GROUPNAME) < 20) {
		texto($GROUPNAME, 0, 236, 1, 0, $arial, $black, 9, 0, 0);
	} else {
		texto($GROUPNAME, 0, 236, 1, 0, $arialNB, $black, 9, 0, 0);
	}
