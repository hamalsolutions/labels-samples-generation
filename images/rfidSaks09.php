<?php //                     1        2        3        4      5        6        7
$correctos = array('QTY', 'STYLE', 'COLOR', 'COLOR2', 'UPC', 'SIZE', 'PRICE', 'PCS-SET');
...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	texto($SET, 10, 80, 0, 0, $arialNB, $black, 8, 0, 0);
