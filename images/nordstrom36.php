<?php //                     1           2         3      4       5            6           7         8
$correctos = array('QTY', 'STYLE', 'COLOR NAME', 'UPC', 'SIZE', 'DEPT', 'COMPARABLE-PRICE', 'PRICE', 'SAVINGS');
...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	texto('COMPARABLE VALUE:', 15, 274, 0, 0, $arial, $black, 6, 0, 0);
	texto(sinSigno($COMPARABLE), 0, 274, 2, 10, $arialBoldSlash, $black, 11, 0, 1);

	perforacion(175, 30, 256);

	texto(suffix($SAVINGS, ' Savings'), 15, 292, 0, 0, $arial, $black, 7, 0, 0);
