<?php                    //    1        2      3      4      5    
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        texto('D',0,88,1,0,$logo,$black,49,0,0);
        texto('®',118,45,0,0,$arialBold,$black,10,0,0);
        ...
        if ($PRICE=='22' || $PRICE=='14' || $PRICE=='15' || $PRICE=='20' || $PRICE=='24' || $PRICE=='25' || $PRICE=='28' || $PRICE=='30' || $PRICE=='35' || $PRICE=='40'){
