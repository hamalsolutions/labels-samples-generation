<?php                     //    1      2       3      4      5        6        7          8         9   
    $correctos = array('QTY','COLOR','SIZE','STYLE','UPC','PRICE','D/S/F','DESCRIPTION','SEASON','ITEM#');
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        texto($ITEM,0,38,2,strlen($ITEM)>12?20:25,$MyriadPro,$black,  strlen($ITEM)>12?6:7,0,0);
