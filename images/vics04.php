<?php                     //   1       2       3      4     5        6
    $correctos = array('QTY','COLOR','SIZE','STYLE','UPC','PRICE','ITEM#');
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        $STYLE = asignar(3,'9055X433T1');
        $UPC = asignar(4,'885347132467');
        $PRICE = asignar(5,'14.99');
        $ITEM = asignar(6,'568476');
        ...
        texto('ITEM#',9,30,0,0,$arial,$black,8,0,0);
        texto($ITEM,9,42,0,0,$arial,$black,7.5,0,0);
        
        texto($STYLE,0,30,2,5,$arial,$black,8,0,0);
