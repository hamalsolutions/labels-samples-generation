<?php                      //   1      2       3      4     5      6      7       8
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        texto($DEPT,0,75,3,60,$arialBold,$black,15,270,0);
        
        texto($CLASS,0,75,1,0,$arialBold,$black,15,270,0);
        
        texto($SUB,0,75,3,-60,$arialBold,$black,15,270,0);
        
        texto('STYLE',75,115,0,0,$arial,$black,9,270,0);
        texto($STYLE,75,135,0,0,$arial,$black,9,270,0);
        
        texto('COLOR',75,165,0,0,$arial,$black,8,270,0);
        texto($COLOR,75,185,0,0,$arial,$black,7.5,270,0);
        
        texto('SIZE',75,220,0,0,$arial,$black,9,270,0);
        texto($SIZE,75,240,0,0,$arial,$black,9,270,0);
        
        texto($PRICE,0,280,3,-60,$arial,$black,15,270,1);
        
        
        // Creacion del Barcode
        barcode($UPC,10,276,1.5,50,'UPC',270);
