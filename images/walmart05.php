<?php                     //    1      2       3      4      5      6        7          8         9
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        texto($FILELINE,texto($SUBCLASS,texto($DEPT,7,395,0,0,$arialBold,$black,9,0,0)-4,395,0,0,$arialBold,$black,9,0,0)-4,395,0,0,$arialBold,$black,9,0,0);
        
        texto($SEASON,7,410,0,0,$arialBold,$black,10,0,0);
        
        texto($COLOR,0,395,2,5,$arialBold,$black,9,0,0);
