<?php                      //      1         2      3       4      5      6      7       8      9
    $correctos = array('QTY','COLOR CODE','COLOR','SIZE','STYLE','UPC','PRICE','DEPT','CLASS','SUB');
    ...
    if (!isset($_GET['csvfile']) && !isset($_POST['selection']))
    {
        ...
        texto($DEPT,0,42,3,60,$arialBold,$black,7,0,0);
        
        texto($CLASS,0,42,3,-10,$arialBold,$black,7,0,0);
        
        texto($SUB,0,42,3,-90,$arialBold,$black,7,0,0);        
        
        texto('STYLE',70,28,0,0,$arial,$black,7,0,0);
        texto($STYLE,110,28,0,0,$arial,$black,7,0,0);
