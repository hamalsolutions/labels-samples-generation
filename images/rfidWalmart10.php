...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	if ($UserUPC_CD == $CHKDIG) {
		texto(formatizarUPC_Texto('123456789012', $UPC), 0, 25, 3, 20, $arial, $black, 12, 0, 0);
	} else {
		texto('Bad Chk Digit: #'.$UserUPC_CD.' *** Should Be: #'.$CHKDIG, 0, 20, 3, 20, $arial, $red, 12, 0, 0);
		texto($UPC, 0, 25, 3, 20, $arial, $red, 12, 0, 0);
	}

	texto($DESCRIPT, 0, 49, 3, 20, $arial, $black, 12, 0, 0);
