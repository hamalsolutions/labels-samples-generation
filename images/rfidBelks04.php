...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	texto('E', 108, 30, 0, 0, $logo, $black, 20, 90, 0);
	texto('BELK', 0, 64, 1, 0, $arialBold, $black, 15, 90, 0);
	texto('Style #:', 10, 102, 0, 0, $arial, $black, 7.5, 90, 0);
	texto('Color:', 10, 132, 0, 0, $arial, $black, 7.5, 90, 0);
	texto('BELK.COM', 0, 294, 1, 0, $arialBold, $black, 10.5, 90, 0);
	If (strlen($STYLE) < 18) {
		texto($STYLE, 46, 102, 0, 0, $arialBold, $black, 8.5, 90, 0);
	} else {
		texto($STYLE, 46, 102, 0, 0, $arialNarrowBold, $black, 8.5, 90, 0);
	}

	If (strlen($COLOR) < 18) {
		texto($COLOR, 46, 132, 0, 0, $arialBold, $black, 8.5, 90, 0);
	} else {
		texto($COLOR, 46, 132, 0, 0, $arialNarrowBold, $black, 8.5, 90, 0);
	}
