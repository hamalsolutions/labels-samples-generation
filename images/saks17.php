<?php //                     1        2       3      4       5         6
$correctos = array('QTY', 'STYLE', 'COLOR', 'UPC', 'SIZE', 'PRICE', 'PCS-SET');
require_once('../includes/html2.php');

if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	// Valores por default para presentar en el formato

	$STYLE = asignar(1, 'RBNO023');
	$COLOR = asignar(2, 'BY WATER');
	$UPC = asignar(3, '046094682289');
	$SIZE = asignar(4, '0/3M');
	...
	texto($COLOR, 10, 42, 0, 0, $arialBold, $black, 11, 0, 0);

	texto($SET, 10, 60, 0, 0, $arialNB, $black, 8, 0, 0);
	//texto('SIZE',0,56,1,0,$timesNewBold,$black,7,0,0);

	texto($SIZE, 0, 138, 1, 0, $arialNB, $black, 14, 0, 0);
