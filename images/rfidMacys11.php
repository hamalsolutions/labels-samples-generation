...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
    ...
    $COLOR = asignar(2, 'GZJ/WOODROSE16');
    $SIZE = asignar(3, 'XS');
    ...
    texto($STYLE, 8, 57, 0, 0, strlen($COLOR) < 12?$arialBold:$arialNarrowBold, $black, 7, 0, 0);

    texto($COLOR, 0, 57, 2, 8, strlen($COLOR) < 12?$arialBold:$arialNarrowBold, $black, 7, 0, 0);
