...
$correctos = array('QTY', 'COLOR', 'SIZE', 'STYLE', 'UPC', 'PRICE', 'DEPT', 'SUBCLASS', 'FINELINE', 'SEASON', 'DESCRIPTION');
...
if (!isset($_GET['csvfile']) && !isset($_POST['selection'])) {
	...
	$DESCRIPTION = asignar(10, 'WOLFPAT');
	...
	for ($i = 1; $i <= 4; $i++) {
		$fontColor = ($SIZE == 'L42/44') ? $black : $white;
	...
	texto($DEPT . $SUBCLASS . $FINELINE, 318, 15, 0, 0, $MyriadPro, $black, 7, 0, 0);

	texto($SEASON, 320, 27, 0, 0, $MyriadPro, $black, 7, 0, 0);

	texto($DESCRIPTION, 0, 310, 1, 0, $MyriadPro, $black, 7, 90, 0);
